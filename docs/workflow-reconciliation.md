...
SavedToOneDrive`). OneDrive reconciliation (steps 3–4), the not-found / retry
states (`NotYetFound`, `NotFound`, `RetrievalError`), and FreeAgent attachment
(step 9) are deferred to later work.
